...
const PageHeader = ({ navItem, setNavItem, setSignIn, setToken, setRole }) => (
    <div >
        ...
        <Header className="header">
            ...
            <h1>Kid Art 4 U</h1>
            <Nav navItem={navItem} setNavItem={setNavItem} setSignIn={setSignIn} setToken={setToken} setRole={setRole} />
